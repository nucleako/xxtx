...
<div class="home">
  ...
  <el-image style="width: 100px; height: 100px;" :src="https://img95.699pic.com/photo/50073/5898.jpg_wh860.jpg"></el-image>
    ...
    <div class="con">
      ...
      <div class="yxzx_con">
        <div class="yxzx_con_item">
          <el-image style="width: 750px; height: 300px" :src="'https://p.qpic.cn/mwegame/0/8720862d6694642b26a4eec47e56bbe3/'" :fit="fit" />
          <div class="yxzx_con_item_r">
            <h4>《神领编年史》试玩版 Fami 通评测：站在前辈们肩膀上的经典 SRPG</h4>
            <p class="yxzx_con_item_uther">作者：齋藤モゲ  2天前</p>
            <p class="yxzx_con_item_text">Square Enix 开发的多平台 SRPG 完全新作《神领编年史》预计将于 2022 年 9 月 22 日登陆 NS/PS5/PS4/XSX/Xbox One/PC（Steam）平台。目前本作的试玩版已经在全平台上线（Steam 版 8 月 11 日推出）。

下文将为大家带来笔者抢先体验了本作 Steam 试玩版之后的评测内容。由于试玩版的存档能够直接继承到正式版中，因此感兴趣的玩家大可趁此机会亲自上手感受感受。</p>
          </div>
        </div>
      </div>
    </div>
