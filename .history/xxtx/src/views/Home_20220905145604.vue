...
<div class="home">
   ...
   <el-carousel :interval="5000" arrow="always" class="con">
    ...
    <div class="con">
      ...
      <div class="yxzx_con">
        <div class="yxzx_con_item">
          <el-image style="width: 375px; height: 150px" :src="'https://p.qpic.cn/mwegame/0/8720862d6694642b26a4eec47e56bbe3/'" :fit="fit" />
