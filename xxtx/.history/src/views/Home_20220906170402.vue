    ...
    <div class="con">
      <div class="footer_center">   
        <div >
          ...
          <div class="cir" style="margin-left: 300px;"><div class="wechat_icon"></div></div>
...
export default {
  ...
  var a1 = document.getElementsByClassName('wechat_icon')
  var a1 = document.getElementsByClassName('wechatImg')
