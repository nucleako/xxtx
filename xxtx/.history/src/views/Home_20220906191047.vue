    ...
    <div class="con">
      <div class="footer_center">   
        <div >
          ...
          <div class="cir" style="margin-left: 300px;" @mouseenter="show()"><div class="wechat_icon"></div></div>
      ...
      <p>@nkkkkk</p>
      <div class="wechatImg">
        <img src="http://43.143.93.202/wechatcode" alt="">
        
      </div>
      <el-dropdown-menu><div class="wechatImg"> 
        <el-dropdown-item><img src="http://43.143.93.202/wechatcode" alt=""></el-dropdown-item>
