  ...
  <div id="footer">
    <div class="con">
      <div class="footer_center">   
        <div >
          <p class='contactSign'>IF U WANNA CONTACT US:</p>
          <el-dropdown>
            <div class="cir el-dropdown-link" style="margin-left: 300px;" @mouseenter="show()"><div class="wechat_icon"></div></div>
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item>      
                  <div class="wechatImg">
                    <img src="http://43.143.93.202/wechatcode" style="width:100%;height: 100%;" alt="">   
                  </div>
                </el-dropdown-item>
              </el-dropdown-menu>
            </template>
          ...
          <el-dropdown>
            <div class="cir el-dropdown-link" ><div class="link_icon"></div></div>
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item>      
                  <div class="link_icon">
          ...
          <el-dropdown>
            <div class="cir el-dropdown-link" ><div class="weibo_icon"></div></div>
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item>      
          ...
          <div class="cir" ><div class="link_icon" ></div></div>
